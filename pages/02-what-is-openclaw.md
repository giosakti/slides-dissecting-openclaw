...
<div class="grid grid-cols-2 gap-8 mt-6">
  <div class="text-lg">
    <ul>
      <li>Runs on <strong>your devices</strong>, answers on <strong>your channels</strong></li>
  ...
  <div>
    <p class="text-sm font-bold uppercase tracking-wider opacity-40">Created by</p>
    <p class="text-lg mt-2"><strong>Peter Steinberger</strong></p>
...
<div class="grid grid-cols-2 gap-x-8 gap-y-4 mt-8">
  <div class="p-4 bg-gray-100 rounded-lg">
    <p class="font-bold">Bot ↔ Messaging Gateway</p>
  ...
  <div class="p-4 bg-gray-100 rounded-lg">
    <p class="font-bold">Memory Systems for Agents</p>
    <p class="dim text-sm">Already exists</p>
  </div>
  <div class="p-4 bg-gray-100 rounded-lg">
    <p class="font-bold">Self-hosted LLM Orchestration</p>
    <p class="dim text-sm">Already exists</p>
  </div>
</div>

<p class="mt-8 text-center text-xl opacity-60">So why is OpenClaw wildly successful?</p>
