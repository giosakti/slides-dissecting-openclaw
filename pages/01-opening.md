...
<div class="grid grid-cols-4 gap-6 mt-10">
  <div>
    <p class="text-3xl font-bold accent">40.5%</p>
    <p class="label">Engineering</p>
  </div>
  <div>
    <p class="text-3xl font-bold accent">9.2%</p>
    <p class="label">Product</p>
  </div>
  <div>
    <p class="text-3xl font-bold accent">8.1%</p>
    <p class="label">Management</p>
  </div>
  <div>
    <p class="text-3xl font-bold accent">7.2%</p>
    <p class="label">C-Suite</p>
  </div>
</div>
